(function() {
  ...
  _.last = function(array, n) {
    ...
    if (n === undefined) {
      ...
      for (var i = (n < array.length ? array.length - n : 0); i < array.length; i++) {
  ...
  _.reject = function(collection, test) {
    ...
    // filter returns those that pass a test
  ...
  _.extend = function(obj) {
    ...
    _.each(sources, function(object){
  ...
  _.delay = function(func, wait) {
    // need to parse arguments to retreive arguments after 2
    // set setTimeout(function, milliseconds)
    var args = [];
